...
### 5.	Test the Function
  ...
  3.	Go to the S3 bucket and verify that files older than 90 days have been removed.
...
### 1.	Set Up S3 Bucket
  ...
  Click Create Bucket.
  Create the Bucket:
  Name of bucket my-bucket-cleanup and choose a region.
  Leave the default settings for Block Public Access and other configurations.
  Click Create Bucket. 
...
### 5.	Test the Lambda Function
  ...
  Verify that files older than 30 days have been deleted, and newer files are still present.
...
### 5.	Test the Lambda Function
  ...
  Click Test again to run the function.
  Check Snapshots
  Go to the EC2 Dashboard and select Snapshots under Elastic Block Store.
...
### 6.	Set Up Event Source (Bonus)
  ...
  Under Targets, choose Lambda Function, and select your EBSBackupCleanup Lambda function.
  Click Create to save the CloudWatch rule.
